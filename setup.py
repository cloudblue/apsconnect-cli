...
setup(
    ...
    description='A command line tool that automates lifecycle management of APS packages generated by CloudBlue Connect '
                'into the CloudBlue Commerce instance.',
